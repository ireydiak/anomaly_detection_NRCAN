...
python -m pyad.lightning_cli --config models/IDS2018/_data.yaml --config models/IDS2018/_trainer.yaml --config models/IDS2018/dsebm-e.yaml --save_dir experiments/training/dsebm-e --n_runs 5 &&
python -m pyad.lightning_cli --config models/IDS2018/_data.yaml --config models/IDS2018/_trainer.yaml --config models/IDS2018/dsebm-r.yaml --save_dir experiments/training/dsebm-r --n_runs 5 &&
